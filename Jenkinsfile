pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'IDEA_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-intellij-idea'
    CONTAINER_NAME = 'intellij-idea'
    DOCKERHUB_IMAGE = 'linuxserver/intellij-idea'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-intellij-idea/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-intellij-idea\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-intellij-idea\" \
